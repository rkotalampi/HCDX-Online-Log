...
# Check for errors.
  if (!$result) {
    ...
    if($usergroup == 'Finland'){
      print "Thank you for confirming your email account. <b> Your account is not yet active </b>. This group requires
	all accounts to be approved before activation. System administrators
	have been notified and your account will be active soon. You will receive an email once the account has been activated.\n\nThank you!";
...
function signupForm () {
 ...
 # Nothing more than spitting out HTML for the form
  ...
  print "<option value='Finland' Selected>Finland";
  print "<option value='hcdx'>Hard-Core-DX International";
  print "</select>\n";
  print "</td></tr></table>";
...
# Message sent in the e-mail to the user that's signing up.
 $message = "You or someone using your email address has requested an account on the HCDX Online Log system. If you requested the account please confirm it within 48 hours of the request. If this wasn't you, please forward this message to $sender.\n\nTo activate the account please go to\n\n 
